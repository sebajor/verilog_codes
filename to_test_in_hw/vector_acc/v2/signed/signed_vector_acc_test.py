...
@cocotb.test()
async def signed_vector_acc_test(dut, vec_len=64, acc_len=10, test_len=4, din_width = 16, dout_width=32):
...
async def signed_input(dut,din_width, dout_width, vec_len=64,acc_len=5, test_len=4):
    ...
    out_vals = await write_continuous(dut, data, din_width, dout_width)
...
async def write_continuous(dut, dat,din_width,dout_width):
    """
        dat: [vec_len, acc_len]
        wait: wait between each vec_len
    """
