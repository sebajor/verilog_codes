...
@cocotb.test()
async def rfi_correlation_test(dut, iters=2**14, din_width=9, din_point=8,
        dout_width=18, dout_point=10, acc_len=10, filename='../tone.hdf5',
        shift=6, thresh=0.5):
    #setup dut
    ...
    ##gold values computation
    corr = beam*np.conj(rfi)
