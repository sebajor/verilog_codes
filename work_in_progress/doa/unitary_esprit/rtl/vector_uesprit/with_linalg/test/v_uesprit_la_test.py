...
@cocotb.test()
async def v_uesprit_la_test(dut, acc_len=5, vec_len=512, din_width=18, 
        din_pt=17, dout_width=16, dout_pt=13, xspace=0.01):
    freqs = np.ones(20)*4
    ...
    #np.save('spec0',spec0); np.save('spec1',spec1)
