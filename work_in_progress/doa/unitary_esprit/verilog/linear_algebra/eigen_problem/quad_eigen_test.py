...
@cocotb.test()
async def quad_eigen(dut, iters=256,din_width=16, din_pt=15, dout_width=19,dout_pt=12,
        thresh=0.05, cont=1, burst_len=10):
...
async def write_data(dut, data, cont, burst):
    if(cont):
